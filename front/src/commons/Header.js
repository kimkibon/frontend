...
const header = () => {
  ...
  <div class="container-fluid">
    <Link to ='/'><img src={logoImage} alt="Gare" class="img-logo" /></Link>
  ...
  {/* -- 홈으로 가기 -- */}
    <div class="collapse navbar-collapse" id="navbarColor03" >
      ...
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link active" href="/myPage">myPage
            <span class="visually-hidden">(current)</span> 
          </a>
        </li>
      </ul>
      ...
      <div class="menu-icon ml-auto" >
          <a href="/login"><svg xmlns="http://www.w3.org/2000/svg" width="80"
